...
const FrameComponent = () => {
  return (
    <div className="absolute top-[1504px] left-[-20px] w-[1360px] flex flex-col items-start justify-start py-[120px] px-[100px] box-border gap-[80px] text-left text-base text-text-text-text-100 font-text-heading-h6 ">
      <div className="w-[1282px] relative rounded-2xl bg-color-grey-grey-50 h-[765px] right-[39px] overflow-hidden shrink-0 sm:text-[10px] sm:w-[350px] sm:h-[450px] sm:right-[75px] sm:bottom-[800px] ">
        <div className="absolute top-[16px] left-[0px] flex flex-row items-start justify-start gap-[48px]">
          <div className="flex flex-row items-end justify-start gap-[37px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[48px] ">
              <div className="flex flex-col items-start justify-start gap-[16px] text-xl text-black1">
                ...
                <div className="w-[301px] relative text-sm leading-[200%] text-text-text-text-200 inline-block sm:text-[12px] sm:w-[150px]">
          ...
          <div className="w-[872px] shadow-[0px_4px_20px_rgba(0,_0,_0,_0.05)] rounded-[8.64px] bg-white box-border flex flex-col items-start justify-start p-[25.9px] text-sm text-black1 border-[1.1px] border-solid border-color-grey-grey-200 sm:hidden sm:bg-red-600 sm:w-[500px] sm:h-[800px] sm:absolute sm:left-[1px]">
      ...
      <div className="w-[750px] relative text-29xl font-medium text-black inline-block sm:text-[20px] sm:right-11 sm:inline-block sm:w-[300px] sm:bottom-[450px]">
