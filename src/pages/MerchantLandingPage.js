...
const MerchantLandingPage = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[4480px] overflow-y-auto text-center text-[18px] text-black font-text-heading-h6 sm:h-[800px] sm:w-full sm:m-0 sm:p-0 sm:overflow-x-hidden">
      <div className="absolute top-[0px] left-[1px] bg-gray-200 w-[1348px] h-[1300px] overflow-y-auto sm:w-[800px] sm:h-[500px]">
        <div className="absolute top-[279px] left-[calc(50%_-_385px)] w-[751px] flex flex-col items-center justify-start gap-[32px]">
          <div className="w-[509px] relative leading-[150%] inline-block sm:text-[15px] sm:w-[300px] sm:right-[210px] sm:bottom-[120px]">{`What you need, when you need it. Your food, grocery, everyday essentials and your packages delivered to your door. `}</div>
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-start justify-start md:w-[900px] md:gap-[5px]">
            <button className="cursor-pointer [border:none] py-med px-big bg-shopprgreen w-[300px] rounded-radius-med flex flex-row items-center justify-center box-border sm:absolute sm:right-[490px] sm:w-[200px] sm:bottom-[107px] sm:py-[10px]">
        ...
        <div className="absolute top-[125px] left-[326px] text-[64px] leading-[120%] font-text-heading-h1 inline-block w-[751px] sm:leading-[120%] sm:inline-block sm:left-[0px] sm:w-[360px] sm:top-[70px] sm:text-[32px]">
          All your business needs in one place
        </div>
        <img
          className="absolute top-[509.4px] left-[calc(50%_-_544px)] rounded-xl w-[1088px] h-[773.7px] object-cover sm:w-[350px] sm:h-[200px] sm:left-[3px] sm:top-[290px]
          ]"
          alt=""
          src="/image-3@2x.png"
        />
      ...
      <div className="absolute top-[2637px] left-[calc(50%_-_723px)] w-[1360px] flex flex-col items-center justify-start pt-0 px-[100px] pb-[120px] box-border gap-[64px] text-29xl ">
        <div className="self-stretch relative font-medium sm:bottom-[750px] sm:left-[40px] sm:text-[20px]">
          Get started in 3 easy steps
        </div>
        <div className="self-stretch flex flex-row items-start justify-start gap-[24px] text-left text-xl sm:absolute sm:left-[575px] sm:block sm:bottom-[200px]">
          <div className="self-stretch flex-1 rounded-3xl bg-gray-100 overflow-hidden flex flex-col items-start justify-start sm:pb-0 sm:w-[300px]">
            ...
            <div className="self-stretch flex-1 flex flex-col items-start justify-start pt-xlarge px-big pb-big gap-[16px] ">
              <div className="self-stretch relative leading-[120%] font-medium sm:bottom-7">
                Signup and complete verification
              </div>
              <div className="self-stretch relative text-base leading-[150%] text-text-text-text-200 sm:bottom-7">
                Sign up online or download the mobile app to get started. P
              </div>
            </div>
          </div>
          <div className="self-stretch flex-1 rounded-3xl bg-gray-100 overflow-hidden flex flex-col items-start justify-start sm:w-[300px]">
            <div className="w-[397.3px] flex-1 relative bg-white overflow-hidden hidden" />
            <div className="self-stretch flex-1 flex flex-col items-start justify-start pt-xlarge px-big pb-big gap-[16px]">
          ...
          <div className="flex-1 rounded-3xl bg-gray-100 overflow-hidden flex flex-col items-start justify-start sm:w-[300px]">
            <div className="w-[397.3px] flex-1 relative bg-white overflow-hidden hidden" />
